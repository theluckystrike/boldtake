...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // DEBUGGING: Add direct test for login button
    setTimeout(() => {
        const testLoginBtn = document.getElementById('login-btn');
        console.log('🔍 Direct button test:', {
            button: testLoginBtn,
            exists: !!testLoginBtn,
            visible: testLoginBtn ? testLoginBtn.offsetParent !== null : false,
            disabled: testLoginBtn ? testLoginBtn.disabled : 'N/A'
        });
...
function setupAuthEventListeners() {
    ...
    console.log('🔍 BoldTakeAuthManager available:', !!window.BoldTakeAuthManager);
    ...
    // DEBUGGING: Check if elements are actually in the DOM
    if (!loginBtn) {
        console.log('❌ Login button not found! Checking DOM...');
