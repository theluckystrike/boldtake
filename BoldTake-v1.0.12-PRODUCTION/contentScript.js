...
const SECURITY_CONFIG = {
  // Rate limiting - CRITICAL SAFETY FEATURES
  MAX_COMMENTS_PER_DAY: 120,  // Reduced for safety (was 155)
  MAX_COMMENTS_PER_HOUR: 12,  // NEW: Hourly limit to prevent bursts
  MAX_BURST_ACTIONS: 3,        // NEW: Max actions in 5 minute window
  
  // Timing constraints (milliseconds) - ENHANCED SAFETY
  MIN_DELAY_BETWEEN_ACTIONS: 120000,  // 2 minutes minimum (was 1 minute)
  MAX_DELAY_BETWEEN_ACTIONS: 300000,  // 5 minutes maximum
  BURST_COOLDOWN_DURATION: 600000,    // NEW: 10 minute cooldown after burst
...
// CRITICAL SAFETY FUNCTIONS - Protect user accounts from being flagged
function checkBurstProtection() {
  ...
  sessionStats.recentActions = sessionStats.recentActions.filter(time => time > fiveMinutesAgo);
